...
pub async fn ingestion_batch(
    ...
    let local_var_uri_str =
        format!("{}/api/public/ingestion", local_var_configuration.base_path);
    ...
    local_var_req_builder =
        local_var_req_builder.json(&ingestion_batch_request);
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<IngestionBatchError> =
