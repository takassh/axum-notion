...
pub async fn trace_get(
    ...
    let local_var_uri_str = format!(
        ...
        traceId = crate::apis::urlencode(trace_id)
    );
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<TraceGetError> =
...
pub async fn trace_list(
    ...
    let local_var_uri_str =
        format!("{}/api/public/traces", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client
        .request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = session_id {
        local_var_req_builder = local_var_req_builder
            .query(&[("sessionId", &local_var_str.to_string())]);
    }
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<TraceListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
