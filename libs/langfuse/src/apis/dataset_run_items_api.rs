...
pub async fn dataset_run_items_create(configuration: &configuration::Configuration, create_dataset_run_item_request: models::CreateDatasetRunItemRequest) -> Result<models::DatasetRunItem, Error<DatasetRunItemsCreateError>> {
    ...
    let local_var_uri_str = format!("{}/api/public/dataset-run-items", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&create_dataset_run_item_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DatasetRunItemsCreateError> = serde_json::from_str(&local_var_content).ok();
