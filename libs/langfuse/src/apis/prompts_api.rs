...
pub async fn prompts_create(
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<PromptsCreateError> =
...
pub async fn prompts_get(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        promptName = crate::apis::urlencode(prompt_name)
    );
    let mut local_var_req_builder = local_var_client
    ...
    if let Some(ref local_var_str) = label {
        local_var_req_builder = local_var_req_builder
            .query(&[("label", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder
            .header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<PromptsGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn prompts_list(
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<PromptsListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
